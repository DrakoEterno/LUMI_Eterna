...
# Convertido a ASYNC utilizando client.aio para no congelar FastAPI
...
# Tarea asíncrona en segundo plano para procesar Telegram
...
# Convertido a ASYNC usando client.aio
...
async def telegram_webhook(request: Request):
    ...
    if "message" in data and "text" in data["message"]:
        ...
        # Responde 200 OK inmediatamente a Telegram y procesa a Gemini en segundo plano
...
// Función enviar optimizada con bloqueo de botón ante múltiples clics
